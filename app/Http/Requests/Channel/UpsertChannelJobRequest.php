...
class UpsertChannelJobRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'notify_message_server_group_message'=>'nullable|required_if:is_notify_message_server_group,1',
            'notify_option'=>'integer|required_if:is_notify_message_server_group,1',
    ...
    public function messages(): array
    {
        return [
            ...
            'notify_message_server_group_message.required_if'=>'Enter a message which the server group should receive',
