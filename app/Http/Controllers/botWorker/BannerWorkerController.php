...
class BannerWorkerController extends Controller
{
    ...
    public function bannerWorkerCreateBanner($serverID): void
    {
        ...
        $this->logController = new Ts3LogController('bannerWorker', $this->serverID);
                        ...
                        foreach ($bannerOptions as $bannerOption) {
                            ...
                            switch ($bannerOption->rel_cat_banner_option->pes_code) {
                                ...
                                case 'get_online_time':
                                    ...
                                    $text = '';
                                    if ($day != 0){$text = $text.$day." Tag/e ";}
                                    if ($hours != 0){$text = $text.$hours." Stunde/n ";}
                                    if ($minutes != 0){$text = $text.$minutes." Minute/n";}
                                    break;
                                default:
