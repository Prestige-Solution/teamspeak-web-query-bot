        ...
        <form class="was-validated" method="post" action="{{Route('serverConfig.create.server')}}">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5 fw-bold" id="CreateServerLabel">Add Server</h1>
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-9">
                            <input class="form-control" type="text" name="qa_name" id="qa_name" placeholder="Query admin name" maxlength="30" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-9">
                            <select class="form-select" name="mode" id="mode">
                                <option value="{{\App\Models\tsBot\tsServerConfig::tsConnectModeSSH}}">SSH</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mb-2">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-9">
                            <textarea class="form-control" name="description" id="description" rows="3" maxlength="255" placeholder="Your notes"></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer d-flex justify-content-between">
                    <button type="submit" class="btn btn-primary">Submit & initialize</button>
