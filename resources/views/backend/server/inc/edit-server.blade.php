        ...
        <form class="was-validated" method="post" action="{{Route('serverConfig.update.server')}}">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5 fw-bold" id="UpdateServer{{ $server->id }}Label">Server "{{ $server->server_name }}" bearbeiten:</h1>
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-9">
                            <textarea class="form-control" name="description" id="description" rows="3" maxlength="255" placeholder="Hier ist Platz für deine Notizen">{{ $server->description }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Abbrechen</button>
                    <button type="submit" class="btn btn-primary" name="server_id" value="{{ $server->id }}">Speichern</button>
                </div>
            </div>
        </form>
    </div>
